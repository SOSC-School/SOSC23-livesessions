...
c.KubeSpawner.image = 'ghcr.io/sosc-school/sosc23-jupyterlab:latest'
...
c.ConfigurableHTTPProxy.auth_token = "asdnnljalsdkajsdlkj"
...
c.KubeSpawner.storage_class = "openebs-jiva-csi-default"
...
c.KubeSpawner.extra_containers = [
    {
        ...
        "image": "ghcr.io/sosc-school/sosc23-mlflow:v0.0.4",
        "command": ["mlflow", "server",  "--host", "0.0.0.0", "--serve-artifacts", "--artifacts-destination",  "s3://{username}", "--backend-store-uri", "/data/mlflow"],
        "env": [
            {
                "name": "AWS_ACCESS_KEY_ID", 
                "value": "YF1K1Y0XDWD7EAT6TNT0"
            },
            {
                "name": "AWS_SECRET_ACCESS_KEY", 
                "value": "SibX9aBnF38GAxi3JoSC3TdpAYuSAnlGpCsSL5hZ"
            },
            {
                "name": "MLFLOW_S3_ENDPOINT_URL", 
                "value": "https://minio.131.154.99.220.myip.cloud.infn.it"
            },
            {
...
c.KubeSpawner.init_containers = [
    {
        ...
        "image": "alpine:3",
        "command": ["chown", "-R", "1000:1000", "/mnt/work"],
        "volumeMounts": [{
            "name": "claim",
            "mountPath": "/mnt/work"
    }]
    ...
    {
        "name": "take-mlflow-dir-ownership",
        "image": "alpine:3",
        "command": ["sh", "-c"],
        "args": ["mkdir -p /data/mlflow && chown -R 0:0 /data/mlflow"],
        "volumeMounts": [{
            "name": "claim",
            "mountPath": "/data"
    }]
    ...
    {
        "name": "sync-script",
        "image": "ghcr.io/sosc-school/sosc23-sync:latest",
        "command": ["python3", "/opt/bin/get_users.py"],
        "env": [
            {
                "name": "USERNAME", 
                "value": "{username}"
